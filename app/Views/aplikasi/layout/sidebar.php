        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <ul class="menu-nav">
                ...
                <li class="menu-section">
                    <h4 class="menu-text">Verifikasi Dokumen</h4>
                ...
                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                <a href="siswaup" class="menu-link menu-toggle">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">Unggah</span>
                                </a>
                            </li>
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    ...
                                    <span class="menu-text">Tampil</span>
                                </a>
                            </li>
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="layout/themes/aside-light.html" class="menu-link">
                                    ...
                                    <span class="menu-text">Semester 1</span>
                                </a>
                            </li>
                            <li class="menu-item" aria-haspopup="true">
                                <a href="layout/themes/header-dark.html" class="menu-link">
                                    ...
                                    <span class="menu-text">Semester 2</span>
                                </a>
                            </li>
                            <li class="menu-item" aria-haspopup="true">
                                <a href="layout/themes/header-dark.html" class="menu-link">
                                    ...
                                    <span class="menu-text">Semester 3</span>
                                </a>
                            </li>
                            <li class="menu-item" aria-haspopup="true">
                                <a href="layout/themes/header-dark.html" class="menu-link">
                                    ...
                                    <span class="menu-text">Semester 4</span>
                                </a>
                            </li>
                            <li class="menu-item" aria-haspopup="true">
                                <a href="layout/themes/header-dark.html" class="menu-link">
                                    ...
                                    <span class="menu-text">Semester 5</span>
                                </a>
                            </li>
                            <li class="menu-item" aria-haspopup="true">
                                <a href="layout/themes/header-dark.html" class="menu-link">
                                    ...
                                    <span class="menu-text">Semester 6</span>
                                </a>
                            </li>
                            <li class="menu-item" aria-haspopup="true">
                                <a href="layout/themes/header-dark.html" class="menu-link">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="layout/subheader/tabbed.html" class="menu-link">
                                    ...
                                    <span class="menu-text">Semesester 3</span>
                                </a>
                            </li>
                            <li class="menu-item" aria-haspopup="true">
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="layout/subheader/none.html" class="menu-link">
                                    ...
                                    <span class="menu-text">Semsester 5</span>
                                </a>
                            </li>
                            <li class="menu-item" aria-haspopup="true">
                                <a href="layout/subheader/none.html" class="menu-link">
                                    ...
                                    <span class="menu-text">Semsester 6</span>
                                </a>
                            </li>
                            <li class="menu-item" aria-haspopup="true">
                                <a href="layout/subheader/none.html" class="menu-link">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="layout/general/fluid-content.html" class="menu-link">
                                    ...
                                    <span class="menu-text">Leger</span>
                                </a>
                            </li>
                            <li class="menu-item" aria-haspopup="true">
                                <a href="layout/general/minimized-aside.html" class="menu-link">
                                    ...
                                    <span class="menu-text">Transkrip</span>
                                </a>
                            </li>
