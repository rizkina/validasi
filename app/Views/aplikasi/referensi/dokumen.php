                ...
                <div class="d-flex align-items-center flex-wrap">
                    <div class="form">
                        <div class="card-body">
                            ...
                            <!--begin::Form-->
                            <form method="post" action="<?= site_url('unggahdokumen/import') ?>" enctype="multipart/form-data">
                                <div class="card-body">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <h5>Template.</h5>
                                                    <p>
                                                        Klik <a href="#" title="File Template" data-toggle="tooltip">unduh</a> untuk mengambil file
                                                        template.
                                                    </p>
                                                    <hr>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-center">
                                        <div class="dropdown-menu-content">
                                            <ul class="navi flex-column navi-hover py-2">
                                                <li class="navi-header font-weight-bolder text-uppercase font-size-sm text-primary pb-2 text-center">
                                                    Choose an option:</li>
                                                <div class="btn-group-vertical d-flex justify-content-center" role="group" aria-label="Vertical button group">
                                                    <button type="button" class="btn btn-outline-primary font-weight-bolder" onclick="selectedExcel()">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-excel-fill" viewBox="0 0 16 16">
                                                            <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0M9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1M5.884 6.68 8 9.219l2.116-2.54a.5.5 0 1 1 .768.641L8.651 10l2.233 2.68a.5.5 0 0 1-.768.64L8 10.781l-2.116 2.54a.5.5 0 0 1-.768-.641L7.349 10 5.116 7.32a.5.5 0 1 1 .768-.64" />
                                                        </svg>Excel
                                                    </button>
                                                    <form id="exportFormExcel" action="" method="get">
                                                        <input type="hidden" id="pilKelasExcel" name="kelasexcel" value="">
                                                    </form>
                                                    <button type="button" class="btn btn-outline-primary font-weight-bolder" onclick="selectedPdf()">
